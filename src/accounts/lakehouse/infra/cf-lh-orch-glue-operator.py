...
def initiate_workflow(event, context):
    ...
    if 'Payload' in jEvent:
        ...
        glueWorkflowName = jEvent['Payload']['LhGlueWorkflowName']
        ...
        response['LhGlueWorkflowName'] = jEvent['Payload']['LhGlueWorkflowName']
        response['RunId'] = jEvent['Payload']['RunId']
    else:
        glueWorkflowName = jEvent['LhGlueWorkflowName']
        ...
        response['LhGlueWorkflowName'] = jEvent['LhGlueWorkflowName']
        response['statusCode'] = 202
